...
<ul>
<li>Maskdetection.ipynb: Scrip python eseguito su Google Colab per l'allenamento e l'esportazione del modello</li>
<li>detect.tflite: Modello TensorFlow Lite</li>
<li>label.txt: Etichette</li>
<li>Script Python per l'inferenza su Raspberry Pi 3B+</li>
</ul>
